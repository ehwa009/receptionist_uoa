...
if("TRUE" STREQUAL "TRUE")
  set(face_recognition_SOURCE_PREFIX /home/eddie/receptionist_uoa/src/procrob_functional)
  set(face_recognition_DEVEL_PREFIX /home/eddie/receptionist_uoa/devel)
  ...
  set(face_recognition_INSTALL_PREFIX /home/eddie/receptionist_uoa/install)
...
if(NOT "/home/eddie/receptionist_uoa/devel/include " STREQUAL " ")
  set(face_recognition_INCLUDE_DIRS "")
  set(_include_dirs "/home/eddie/receptionist_uoa/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'face_recognition' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/eddie/receptionist_uoa/src/procrob_functional/${idir}'.  Ask the maintainer 'Pouyan Ziafati (Author) <pouyan.ziafati@uni.lu>' to fix it.")
    endif()
